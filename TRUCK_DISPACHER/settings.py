"""
Django settings for TRUCK_DISPACHER project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-pb0@8*=9rs1=v-hh4_m)a%j_a4r9z=(utz(hi$poh%8=c#+w^w')
...
ROOT_URLCONF = "TRUCK_DISPACHER.urls"
